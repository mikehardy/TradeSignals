...
public class FredTextParser
{
    ...
    public void setFredSeriesText(String fredSeriesText) { this.fredSeriesText = fredSeriesText; }
    public String getFredSeriesText() { return fredSeriesText; }
    ...
    private TreeMap<Date, BigDecimal> observations = new TreeMap<Date, BigDecimal>();
    ...
    public void parseFredSeries(String fredSeriesText)
    {
        ...
        for (String seriesLine : seriesLines)
        {
            ...
            if (seriesLine.contains("Last Updated:"))
            {
                ...
                SimpleDateFormat updatedFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm a zzz");
                try
                {
            ...
            if (parsingObservations)
            {
                ...
                {
                    contraction = true;
                    Log.d(TAG, "in contraction on " + getLastObservationDate()
    ...
    public BigDecimal getSMA(int period)
    {
